...
/* ============================================================
   HEADER — minimal: logo (left) + single Shop link (right)
   ============================================================ */
function SiteHeader() {
  return (
    <header className='sticky top-0 z-40 border-b border-border bg-background'>
      <div className='mx-auto flex max-w-[1480px] items-center justify-between px-5 py-4 md:px-16'>
        <Link href='/' className='flex items-center gap-2.5' aria-label='LlamaBlaze'>
        ...
        <Link
          href='/shop'
          className='inline-flex items-center gap-2 rounded-full border-[1.5px] border-foreground px-5 py-2 text-[12px] font-semibold uppercase tracking-[0.18em] transition-colors hover:bg-foreground hover:text-background'
        >
          Shop
        </Link>
      </div>
