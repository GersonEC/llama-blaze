...
export default function CatalogPage() {
  return (
    ...
    >
      <div className='mx-auto w-full max-w-[440px] px-6 py-8 sm:max-w-2xl lg:max-w-6xl'>
        ...
        <footer className=' mt-6 flex items-center justify-between border-t border-zinc-200 text-[11px] uppercase tracking-[0.2em] text-zinc-500'>
          <span className='mt-4'>{CATALOG_META.footerLocation}</span>
